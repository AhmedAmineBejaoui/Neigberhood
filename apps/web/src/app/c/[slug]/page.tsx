          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                <Link href={`/c/${slug}/create?type=announcement`} className="block w-full text-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                  Create Announcement
                </Link>
                <Link href={`/c/${slug}/create?type=service`} className="block w-full text-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                  Request Service
                </Link>
                <Link href={`/c/${slug}/create?type=listing`} className="block w-full text-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                  List Item
                </Link>
              </div>
            </div>
